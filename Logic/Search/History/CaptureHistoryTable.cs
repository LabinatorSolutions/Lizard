...
namespace Lizard.Logic.Search.History
{
    public readonly unsafe struct CaptureHistoryTable
    {
        ...
        private const int CaptureHistoryElements = 12 * 64 * 6;
        ...
        public StatEntry this[int ourPiece, int toSquare, int capturedPt]
        {
            get => _History[HistoryIndex(ourPiece, toSquare, capturedPt)];
            set => _History[HistoryIndex(ourPiece, toSquare, capturedPt)] = value;
        }

        public static int HistoryIndex(int ourPiece, int toSquare, int capturedPt) => (capturedPt * 768) + (toSquare * 12) + ourPiece;
